      ...
      <div className="relative w-full max-w-6xl grid lg:grid-cols-2 items-center gap-10">
        ...
        >
          ...
          <p className="mt-6 max-w-md text-lg leading-8 text-white/60">
            Join SunoNaa and build a beautiful, private space for meaningful
            conversations with the people who matter.
          </p>

          <div className="mt-10 grid grid-cols-3 gap-4 max-w-md">
            {["Private", "Beautiful", "Secure"].map((item, index) => (
              <motion.div
                key={item}
              ...
              >
                <div className="flex justify-center">
                  <motion.img
                    src={logo}
                    alt="SunoNaa Logo"
                    className="w-32 h-32 object-contain select-none drop-shadow-[0_10px_35px_rgba(255,77,141,0.35)]"
                    draggable={false}
                    animate={{ y: [0, -8, 0] }}
                    transition={{
                      duration: 4,
              ...
              >
                <div>
                  ...
                  <div className="relative mt-2">
                    <User className="absolute left-4 top-1/2 h-5 w-5 -translate-y-1/2 text-[#FF8AB4]/70" />
                    <input
                      type="text"
                      required
                ...
                <div>
                  ...
                  <div className="relative mt-2">
                    ...
                    <input
                      ...
                      required
                      className="h-14 w-full rounded-2xl border border-white/10 bg-white/5 px-4 py-4 pl-12 pr-12 text-white placeholder:text-white/30 shadow-inner outline-none transition-all duration-300 focus:border-[#FF4D8D] focus:bg-white/10 focus:shadow-[0_0_25px_rgba(255,77,141,0.25)]"
